# Project 5 - *Tweeter-Twit*

**Tweeter-Twit** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
1. I would like to discuss debugging in depth
2. I would like to discuss how to retrieve information or help faster

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/Qw8Vf2W.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
I wasn't sure how to do the buttons correctly, because the instructions make it seem like Id only have to implement 2 functions for tweet and favorite, but it needed the other 2.
...
I added persistence of user this week from last weeks stretch. I was able to add color text only the user id in reply stretch goal. I have various formating for pictures in circles. I added a red color to the count to let the user know they are getting close to 0 characters. I made sure to add borders for the text fields to resemble twitter. 

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. I would like to discuss how dictionaries and passing variables works again
2. Autolayout. it's hard.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/a/YEFImSc.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Describe any challenges encountered while building the app.
I didn't quite understand some of the layout stuff and would like to discuss this way more in depth.
